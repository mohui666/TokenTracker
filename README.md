...
An accurate, local-first token usage and cost dashboard for **34 AI coding tools** — plus a desktop pet, **4 native widgets**, and **13 achievement tracks**. No cloud account, no API keys, no setup.
