 ...
 */
export function HeaderGithubStar({ repo = "mohui666/TokenTracker" }) {
  ...
  return (
    ...
    >
      ...
      <span className="text-xs font-medium text-oai-gray-700 dark:text-oai-gray-300 whitespace-nowrap">
        {copy("shared.github.star")}
      </span>
      {stars !== null && (
